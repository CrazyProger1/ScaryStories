...
Revision ID: 990afb3b3cb3
Revises: 
Create Date: 2023-09-01 17:17:31.957303
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['category_name'], ['story_categories.name'], onupdate='CASCADE'),
